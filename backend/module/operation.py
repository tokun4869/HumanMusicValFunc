...
from module.model import model_select
...
def train_operation(dataset_path: str, rank_list: list[int], file_name_list: list[str], set_now_epoch = None, set_status = None, set_model_path = None):
  print("#01 | === SETUP ===")
  print("    | model")
  ...
  for epoch in range(NUM_EPOCHS):
    ...
    print(f"    | Epoch:[ {epoch+1:>3} / {NUM_EPOCHS:>3} ], TrainLoss:[ {train_loss_list.mean():7.2f} ], ValidLoss:[ {valid_loss_list.mean():7.2f} ]")
