...
def music2feature(y: "np.ndarray[np.float32]") -> "np.ndarray[np.float32]":
  ...
  # eature_array.extend(tonnetz_mean.tolist())
...
def get_feature_name_list() -> "list[str]":
  # feature_name_list = ["bpm_value", "rms_mean", "rms_std", "mfcc_mean_1", "mfcc_mean_2", "mfcc_mean_3", "mfcc_mean_4", "mfcc_mean_5", "mfcc_mean_6", "mfcc_mean_7", "mfcc_mean_8", "mfcc_mean_9", "mfcc_mean_10", "mfcc_mean_11", "mfcc_mean_12", "mfcc_std_1", "mfcc_std_2", "mfcc_std_3", "mfcc_std_4", "mfcc_std_5", "mfcc_std_6", "mfcc_std_7", "mfcc_std_8", "mfcc_std_9", "mfcc_std_10", "mfcc_std_11", "mfcc_std_12", "centroid_mean", "centroid_std", "bandwidth_mean", "bandwidth_std", "tonnetz_mean_1", "tonnetz_mean_2", "tonnetz_mean_3", "tonnetz_mean_4", "tonnetz_mean_5", "tonnetz_mean_6", "tonnetz_std_1", "tonnetz_std_2", "tonnetz_std_3", "tonnetz_std_4", "tonnetz_std_5", "tonnetz_std_6", "zcr_mean", "zcr_std"]
  feature_name_list = ["bpm_value", "rms_mean", "mfcc_mean_1", "mfcc_mean_2", "mfcc_mean_3", "mfcc_mean_4", "mfcc_mean_5", "mfcc_mean_6", "mfcc_mean_7", "mfcc_mean_8", "mfcc_mean_9", "mfcc_mean_10", "mfcc_mean_11", "mfcc_mean_12", "mfcc_std_1", "mfcc_std_2", "mfcc_std_3", "mfcc_std_4", "mfcc_std_5", "mfcc_std_6", "mfcc_std_7", "mfcc_std_8", "mfcc_std_9", "mfcc_std_10", "mfcc_std_11", "mfcc_std_12", "zcr_mean", "zcr_std"]
